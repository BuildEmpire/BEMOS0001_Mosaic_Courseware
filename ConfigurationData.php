...
$paramArray[] = $shrewd->getParameter("ConfigurationData", 1, $this->transformed, "transformed", "boolean", "", false);
...
if (isset($shrewdArray[6])) {$this->transformed = $shrewd->setParameter("ConfigurationData", 2, $shrewdArray[6], "transformed", "boolean", "", false);}
if ($shrewdArray[7]) {
...
if (isset($shrewdArray[11])) {$this->language = $shrewd->setParameter("ConfigurationData", 2, $shrewdArray[11], "language", "string", "", false);}
if (isset($shrewdArray[12])) {$this->valid = $shrewd->setParameter("ConfigurationData", 2, $shrewdArray[12], "valid", "boolean", "", false);}
}
}