...
$paramArray[] = $shrewd->getParameter("DataCanvas", 1, $this->sensitiveBoundarySize, "sensitiveBoundarySize", "integer", "", false);
$paramArray[] = $shrewd->getParameter("DataCanvas", 1, $this->resizeHandleSize, "resizeHandleSize", "integer", "", false);
return $paramArray;
}
...
if (isset($shrewdArray[2])) {$this->sensitiveBoundarySize = $shrewd->setParameter("DataCanvas", 2, $shrewdArray[2], "sensitiveBoundarySize", "integer", "", false);}
if (isset($shrewdArray[3])) {$this->resizeHandleSize = $shrewd->setParameter("DataCanvas", 2, $shrewdArray[3], "resizeHandleSize", "integer", "", false);}
}
}