...
if (isset($shrewdArray[1])) {$this->min = $shrewd->setParameter("DataColumns", 2, $shrewdArray[1], "min", "integer", "", false);}
if (isset($shrewdArray[2])) {$this->max = $shrewd->setParameter("DataColumns", 2, $shrewdArray[2], "max", "integer", "", false);}
}
}