...
if (isset($shrewdArray[1])) {$this->min = $shrewd->setParameter("DataRows", 2, $shrewdArray[1], "min", "integer", "", false);}
if (isset($shrewdArray[2])) {$this->max = $shrewd->setParameter("DataRows", 2, $shrewdArray[2], "max", "integer", "", false);}
}
}