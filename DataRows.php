...
if (isset($shrewdArray[1])) {$this->default = $shrewd->setParameter("DataRows", 2, $shrewdArray[1], "default", "integer", "", false);}
if (isset($shrewdArray[2])) {$this->min = $shrewd->setParameter("DataRows", 2, $shrewdArray[2], "min", "integer", "", false);}
if (isset($shrewdArray[3])) {$this->max = $shrewd->setParameter("DataRows", 2, $shrewdArray[3], "max", "integer", "", false);}
}
}