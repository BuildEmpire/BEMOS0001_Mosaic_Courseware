...
if (isset($shrewdArray[1])) {$this->actions = $shrewd->setParameter("RelationshipComponentContainer", 2, $shrewdArray[1], "actions", "list", "\BuildEmpire\Mosaic\Courseware\ValidRelationshipAction", true);}
if (isset($shrewdArray[2])) {$this->events = $shrewd->setParameter("RelationshipComponentContainer", 2, $shrewdArray[2], "events", "list", "\BuildEmpire\Mosaic\Courseware\ValidRelationshipEvent", true);}
if (isset($shrewdArray[3])) {$this->items = $shrewd->setParameter("RelationshipComponentContainer", 2, $shrewdArray[3], "items", "list", "\BuildEmpire\Mosaic\Courseware\RelationshipCollection", true);}
}
}