...
if (isset($shrewdArray[5])) {$this->components = $shrewd->setParameter("ScreenData", 2, $shrewdArray[5], "components", "list", "\BuildEmpire\Mosaic\Courseware\ComponentData", false);}
}
}