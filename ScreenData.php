...
$paramArray[] = $shrewd->getParameter("ScreenData", 1, $this->columns, "columns", "list", "\BuildEmpire\Mosaic\Courseware\Column", true);
...
if (isset($shrewdArray[1])) {$this->columns = $shrewd->setParameter("ScreenData", 2, $shrewdArray[1], "columns", "list", "\BuildEmpire\Mosaic\Courseware\Column", true);}
if (isset($shrewdArray[2])) {$this->components = $shrewd->setParameter("ScreenData", 2, $shrewdArray[2], "components", "list", "\BuildEmpire\Mosaic\Courseware\ComponentData", true);}
}
}