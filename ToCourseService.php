...
class ToCourseService implements IShrewdService
{
protected $_handler;
...
return "BuildEmpire.Mosaic.Project.ToCourseService";
}
...
$param->type = "\BuildEmpire\Mosaic\Project\ConfigurationData";
$param->optional = false;
$params[] = $param;
return $params;
}
...
$param->type = "\BuildEmpire\Mosaic\Project\ScreenData";
$param->optional = false;
$params[] = $param;
return $params;
}
