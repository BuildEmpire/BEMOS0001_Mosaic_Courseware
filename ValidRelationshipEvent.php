...
$paramArray[] = $shrewd->getParameter("ValidRelationshipEvent", 1, $this->data, "data", "mixed", "", true);
return $paramArray;
}
...
if (isset($shrewdArray[4])) {$this->data = $shrewd->setParameter("ValidRelationshipEvent", 2, $shrewdArray[4], "data", "mixed", "", true);}
}
}