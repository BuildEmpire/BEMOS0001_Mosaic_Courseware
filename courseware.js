    ...
    OpenResourceManager: function(fileExtensions, onSelectCallback, onCancelCallback) {
        if (this._shrewd) {
            ...
            if (this._shrewd.local) {
                ...
                if (fileExtensions) {
                    var l = fileExtensions.length;
                    var lArray = new Array();
                    for (var a = 0; a < l; a++) {
                        lArray.push(fileExtensions[a]);
                    }
                    parametersArray.push(lArray);
                } else {
                    parametersArray.push(fileExtensions)
                }
                parametersArray.push(onSelectCallback);
...
var CoursewareColumn = new Class({
    ...
    getShrewd: function() {
        ...
        if (this.components) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.components[a]) ? this.components[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.components)
        }
        return parametersArray;
    },
    /**
        ...
        if (shrewdArray[7]) {
            ...
            for (var a = 0; a < l; a++) {
                if (shrewdArray[7][a]) {
                    ...
                    theClass.setShrewd(shrewdArray[7][a]);
                    lArray[a] = theClass;
                } else {
                    lArray[a] = null;
                }
...
var CoursewareTemplate = new Class({
    ...
    getShrewd: function() {
        ...
        if (this.columns) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.columns[a]) ? this.columns[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.columns)
        }
        return parametersArray;
    },
    /**
...
var CoursewareConfigurationData = new Class({
    ...
    getShrewd: function() {
        ...
        if (this.translations) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.translations[a]) ? this.translations[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.translations)
        }
        if (this.learningPaths) {
            var l = this.learningPaths.length;
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.learningPaths[a]) ? this.learningPaths[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.learningPaths)
        }
        if (this.templates) {
            var l = this.templates.length;
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.templates[a]) ? this.templates[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.templates)
        }
        if (this.components) {
            var l = this.components.length;
            var lArray = new Array();
        ...
        if (this.errors) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push(this.errors[a]);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.errors)
        }
        return parametersArray;
    },
    /**
...
var CoursewareStructureItem = new Class({
    ...
    getShrewd: function() {
        ...
        if (this.children) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.children[a]) ? this.children[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.children)
        }
        if (this.learningPathIds) {
            var lHash = new Hash();
            this.learningPathIds.each(function(v, k) {
                lHash[k] = v;
            });
            parametersArray.push(lHash);
        } else {
            parametersArray.push(this.learningPathIds)
        }
...
var CoursewareEditableFormGroup = new Class({
    ...
    getShrewd: function() {
        ...
        if (this.fields) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.fields[a]) ? this.fields[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.fields)
        }
        return parametersArray;
    },
    /**
...
var CoursewareEditableForm = new Class({
    ...
    getShrewd: function() {
        ...
        if (this.groups) {
            ...
            var lArray = new Array();
            for (var a = 0; a < l; a++) {
                lArray.push((this.groups[a]) ? this.groups[a].getShrewd() : null);
            }
            parametersArray.push(lArray);
        } else {
            parametersArray.push(this.groups)
        }
        return parametersArray;
    },
    /**
